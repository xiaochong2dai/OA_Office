        ...
        <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
            <tr>
                <td align="right" colspan="2" style="height: 25px; background-color: #e1f5fc; text-align: center">
                    <strong><span style="font-size: 10pt">内部短信群发</span></strong>
                </td>
            </tr>
            <tr>
                ...
                <td style="background-color: #ffffff; height: 25px; padding-left: 5px;">
                    ...
                    <span style="color: darkgray">* 请选择用户名，用于内部人员短信</span>
                </td>
            </tr>
            <tr>
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="TextBox2" runat="server" Width="350px" Height="50px" TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 170px; height: 25px; background-color: #e1f5fc">
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/Button/Submit.jpg"
                        OnClick="ImageButton1_Click" ValidationGroup="Neibu" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="right" style="height: 25px; background-color: #e1f5fc; text-align: center;"
                    colspan="2">
                    <strong><span style="font-size: 10pt">外部短信群发</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 170px; background-color: #e1f5fc; height: 25px;">
                ...
                <td style="background-color: #ffffff; height: 25px; padding-left: 5px;">
                    ...
                    <span style="color: darkgray">* 请输入手机号码列表，用 "," 分隔。</span>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 170px; height: 25px; background-color: #e1f5fc">
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:TextBox ID="TextBox4" runat="server" Height="50px" TextMode="MultiLine" Width="350px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right" style="width: 170px; height: 25px; background-color: #e1f5fc">
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/Button/Submit.jpg"
                        OnClick="ImageButton2_Click" ValidationGroup="WaiBu" />
                </td>
            </tr>
        </table>
    </div>
